/*
* Author: Mihai Corlan ( http://corlan.org/ )
*/
package org.corlan.peer2peer {
	...
	public class MultiCastingService extends EventDispatcher {
		...
		private var IPMulticastAddress:String = "225.0.0.1:4000";
		...
		public function MultiCastingService(user:String=null, logEnabled:Boolean = false, 
											gn:String="loveisintheair", ip:String="225.0.0.1:4000", target:IEventDispatcher=null) {
			super(target);
			if (user)
				userName = user;
			else
